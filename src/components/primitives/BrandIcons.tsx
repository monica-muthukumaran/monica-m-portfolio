 ...
 *
 * lucide dropped brand icons, and a generic "git branch" glyph next to a
 * GitHub link reads as a mistake. These are the official marks, inlined at
 * a few hundred bytes each rather than pulling in an icon pack for two shapes.
 */
